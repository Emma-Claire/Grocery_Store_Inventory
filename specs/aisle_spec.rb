...
describe "GroceryStore::Aisle" do
  let(:new_aisle) {GroceryStore::Aisle.new({store_id: 12345, product_id: 101, product_name: 'cookies', product_price: 15.0, product_aisle: 'bakery', product_quantity: 123, discount_price: 4.5})}
